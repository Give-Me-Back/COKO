...
class Test(models.Model):
    deathcnt = models.TextField(db_column='deathCnt', blank=True, null=True)  # Field name made lowercase.
    ...
    isolclearcnt = models.TextField(db_column='isolClearCnt', blank=True, null=True)  # Field name made lowercase.
    isolingcnt = models.TextField(db_column='isolIngCnt', blank=True, null=True)  # Field name made lowercase.
    localocccnt = models.TextField(db_column='localOccCnt', blank=True, null=True)  # Field name made lowercase.
    overflowcnt = models.TextField(db_column='overFlowCnt', blank=True, null=True)  # Field name made lowercase.
    qurrate = models.TextField(db_column='qurRate', blank=True, null=True)  # Field name made lowercase.
    stdday = models.TextField(db_column='stdDay', blank=True, null=True)  # Field name made lowercase.
